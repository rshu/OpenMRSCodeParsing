// $ANTLR 3.4 CPPGrammar.g 2020-12-28 23:01:22
...
public TreeAdaptor getTreeAdaptor() {
        ...
        try {
            ...
            switch (alt19) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: 93, init_decl_name, init_decl_name, init_decl_name, 92, expr
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: 113, init_decl_name, assign_expr, init_decl_name
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt23) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: compound_statement, function_param_list, ctor_list, function_start
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: compound_statement, function_param_list, function_start
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 1 :
                    ...
                    switch (alt38) {
                        case 1 :
                            ...
                            // AST REWRITE
                            // elements: ptr_operator, ptr_operator, parameter_name, param_decl_specifiers, param_decl_specifiers, parameter_name
                            // token labels: 
                            // rule labels: retval
                            // token list labels: 
                            // rule list labels: 
                        ...
                        case 2 :
                            ...
                            // AST REWRITE
                            // elements: param_decl_specifiers, parameter_name, parameter_name, param_decl_specifiers
                            // token labels: 
                            // rule labels: retval
                            // token list labels: 
                            // rule list labels: 
    ...
    public final CPPGrammarParser.if_statement_return if_statement() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: condition, 92, statement, k, 93
            // token labels: k
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final CPPGrammarParser.switch_statement_return switch_statement() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: statement, condition, k, 92, 93
            // token labels: k
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final CPPGrammarParser.for_statement_return for_statement() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: 108, 93, condition, for_init_statement, 92, expr, k, statement
            // token labels: k
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final CPPGrammarParser.do_statement_return do_statement() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: statement, 93, 92, expr, k
            // token labels: k
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt78) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: or_expression, QMARK, COLON, expr, conditional_expression
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt79) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: and_expression, or_expression, 165
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt81) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: 163, inclusive_or_expression, exclusive_or_expression
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    public final CPPGrammarParser.postfix_expression_return postfix_expression() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: func_called, tail, func_called, tail, x, func_called, tail
            // token labels: 
